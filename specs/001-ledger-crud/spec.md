...
- **FR-010**: System MUST require authentication on every operation and reject anonymous requests.
...
- Ledger names have a sensible maximum length (e.g., 100 characters) and descriptions a longer one (e.g., 500 characters); exact limits are an implementation detail aligned with industry norms.
